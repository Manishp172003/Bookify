                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                      ...
                      <div>
                        ...
                        <input
                          ...
                          disabled
                          className="w-full rounded-xl border border-gray-200 bg-gray-50 px-4 py-3 text-xs font-semibold text-gray-400 cursor-not-allowed outline-none"
                      ...
                      <div className="space-y-4">
                        ...
                        <label className="flex items-start gap-3 cursor-pointer">
                          <input
                            ...
                            className="h-4.5 w-4.5 rounded border-gray-300 accent-[#6C4BF4] mt-0.5"
                          />
                          <div>
                            <p className="text-xs font-bold text-[#17152A]">Price Drops Alerts</p>
                            <p className="text-[10px] text-gray-500 mt-0.5 leading-relaxed">Receive alert when books in your wishlist go on sale.</p>
                          </div>
                        </label>
                        <label className="flex items-start gap-3 cursor-pointer">
                          <input
                          ...
                          <div>
                            ...
                            <p className="text-[10px] text-gray-500 mt-0.5 leading-relaxed">Receive updates regarding textbook order updates and receipts.</p>
                          </div>
                        </label>
                        <label className="flex items-start gap-3 cursor-pointer">
                          <input
                          ...
                          <div>
                            ...
                            <p className="text-[10px] text-gray-500 mt-0.5 leading-relaxed">Receive notification when a user proposes a book exchange.</p>
                          </div>
                        </label>
                      </div>
                      ...
                      <div className="space-y-4">
                        ...
                        <label className="flex items-start gap-3 cursor-pointer">
                          ...
                          <div>
                            ...
                            <p className="text-[10px] text-gray-500 mt-0.5 leading-relaxed">Receive mobile message alerts when someone messages you about a book.</p>
                          </div>
                        </label>
                        <label className="flex items-start gap-3 cursor-pointer">
                          <input
                          ...
                          <div>
                            ...
                            <p className="text-[10px] text-gray-500 mt-0.5 leading-relaxed">Receive SMS coordinates 1 hour before a scheduled campus meetup.</p>
                          </div>
                        </label>
                      </div>
                    </div>
                    ...
                    <div className="space-y-5">
                      <label className="flex items-start justify-between gap-4 cursor-pointer">
                        <div className="min-w-0">
                          ...
                          <p className="text-[10px] text-gray-500 mt-0.5">Allow users to view your contact phone number directly on listings.</p>
                        </div>
                        <input
                          type="checkbox"
                          checked={privacy.showPhone}
                          onChange={(e) => setPrivacy({ ...privacy, showPhone: e.target.checked })}
                          className="h-5 w-10 shrink-0 rounded-full border border-gray-300 accent-[#6C4BF4] cursor-pointer"
                        />
                      </label>
                      ...
                      <label className="flex items-start justify-between gap-4 cursor-pointer">
                        <div className="min-w-0">
                          ...
                          <p className="text-[10px] text-gray-500 mt-0.5">Display your hostel name/block on listings to help buyers plan trades.</p>
                        </div>
                        <input
                          type="checkbox"
                      ...
                      <label className="flex items-start justify-between gap-4 cursor-pointer">
                        <div className="min-w-0">
                          ...
                          <p className="text-[10px] text-gray-500 mt-0.5">Buyers must enter a 4-digit code in meetup before escrow cash is released.</p>
                        </div>
                        <input
                          type="checkbox"
