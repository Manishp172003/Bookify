...
import { Calendar, ShieldCheck, Clock, MessageSquare, CornerUpLeft } from "lucide-react";
    ...
    <div className="flex h-screen w-screen overflow-hidden bg-gradient-to-br from-[#F4F2FF] via-[#F8F7FF] to-[#F0F5FF]">
      ...
      <div className="flex min-w-0 flex-1 flex-col h-full">
        <main className="flex-1 overflow-y-auto p-7 animate-fade-in-up">
          ...
          {/* Header */}
          <div className="mb-6">
            <h1 className="text-2xl font-bold text-[#17152A]">Rentals</h1>
            <p className="text-sm text-gray-500">Track textbooks you have rented from others or lent out to students.</p>
          </div>
